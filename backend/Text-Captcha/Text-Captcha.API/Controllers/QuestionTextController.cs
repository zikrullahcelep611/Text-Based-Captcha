...
public class QuestionTextController : ControllerBase
{
    ...
    public QuestionTextController(IRepository<CaptchaText> captchaTextRepository, ICaptchaTextService captchaTextService
    ...
    [HttpGet("GetCaptchaTextWithId/{captchaTextId}")]
